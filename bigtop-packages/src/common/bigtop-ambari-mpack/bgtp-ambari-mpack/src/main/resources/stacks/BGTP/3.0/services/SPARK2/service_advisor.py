...
class Spark2Recommender(service_advisor.ServiceAdvisor):
  ...
  def recommendSPARK2ConfigurationsFromHDP30(self, configurations, clusterData, services, hosts):
    ...
    if "spark-atlas-application-properties-override" in services["configurations"]:
      ...
      spark_thriftspark_conf_properties = self.getServicesSiteProperties(services, "spark-thrift-sparkconf")
      ...
      putSpark2ThriftSparkConfProperty = self.putProperty(configurations, "spark-thrift-sparkconf", services)
      putSpark2AtlasHookProperty = self.putProperty(configurations, "spark-atlas-application-properties-override", services)
      putSpark2AtlasHookPropertyAttribute = self.putPropertyAttribute(configurations,"spark-atlas-application-properties-override")
      ...
      if spark_sac_enabled:
        ...
        self.setOrAddValueToProperty(putSpark2DefautlsProperty, spark_defaults_properties, "spark.driver.extraClassPath", "/usr/lib/hadoop/spark-atlas-connector/*", ":")
        self.setOrAddValueToProperty(putSpark2DefautlsProperty, spark_defaults_properties, "spark.yarn.dist.files", "/etc/spark/conf/atlas-application.properties.yarn#atlas-application.properties", ",")
        self.setOrAddValueToProperty(putSpark2ThriftSparkConfProperty, spark_thriftspark_conf_properties, "spark.driver.extraClassPath", "/usr/lib/hadoop/spark-atlas-connector/*", ":")

        self.setOrAddValueToProperty(putSpark2DefautlsProperty, spark_defaults_properties, "spark.extraListeners", "com.hortonworks.spark.atlas.SparkAtlasEventTracker", ",")
        self.setOrAddValueToProperty(putSpark2DefautlsProperty, spark_defaults_properties, "spark.sql.queryExecutionListeners", "com.hortonworks.spark.atlas.SparkAtlasEventTracker", ",")
        self.setOrAddValueToProperty(putSpark2ThriftSparkConfProperty, spark_thriftspark_conf_properties, "spark.extraListeners", "com.hortonworks.spark.atlas.SparkAtlasEventTracker", ",")
        self.setOrAddValueToProperty(putSpark2ThriftSparkConfProperty, spark_thriftspark_conf_properties, "spark.sql.queryExecutionListeners", "com.hortonworks.spark.atlas.SparkAtlasEventTracker", ",")

        self.setOrAddValueToProperty(putSpark2DefautlsProperty, spark_defaults_properties, "spark.sql.streaming.streamingQueryListeners", "com.hortonworks.spark.atlas.SparkAtlasStreamingQueryEventTracker", ",")
        self.setOrAddValueToProperty(putSpark2ThriftSparkConfProperty, spark_thriftspark_conf_properties, "spark.sql.streaming.streamingQueryListeners", "com.hortonworks.spark.atlas.SparkAtlasStreamingQueryEventTracker", ",")

        putSpark2AtlasHookProperty("atlas.client.checkModelInStart", "false")

      else:

        self.removeValueFromProperty(putSpark2DefautlsProperty, spark_defaults_properties, "spark.driver.extraClassPath", "/usr/lib/hadoop/spark-atlas-connector/*", ":")
        self.removeValueFromProperty(putSpark2DefautlsProperty, spark_defaults_properties, "spark.yarn.dist.files", "/etc/spark/conf/atlas-application.properties.yarn#atlas-application.properties", ",")
        self.removeValueFromProperty(putSpark2ThriftSparkConfProperty, spark_thriftspark_conf_properties, "spark.driver.extraClassPath", "/usr/lib/hadoop/spark-atlas-connector/*", ":")

        self.removeValueFromProperty(putSpark2DefautlsProperty, spark_defaults_properties, "spark.extraListeners", "com.hortonworks.spark.atlas.SparkAtlasEventTracker", ",")
        self.removeValueFromProperty(putSpark2DefautlsProperty, spark_defaults_properties, "spark.sql.queryExecutionListeners", "com.hortonworks.spark.atlas.SparkAtlasEventTracker", ",")
        self.removeValueFromProperty(putSpark2ThriftSparkConfProperty, spark_thriftspark_conf_properties, "spark.extraListeners", "com.hortonworks.spark.atlas.SparkAtlasEventTracker", ",")
        self.removeValueFromProperty(putSpark2ThriftSparkConfProperty, spark_thriftspark_conf_properties, "spark.sql.queryExecutionListeners", "com.hortonworks.spark.atlas.SparkAtlasEventTracker", ",")

        self.removeValueFromProperty(putSpark2DefautlsProperty, spark_defaults_properties, "spark.sql.streaming.streamingQueryListeners", "com.hortonworks.spark.atlas.SparkAtlasStreamingQueryEventTracker", ",")
        self.removeValueFromProperty(putSpark2ThriftSparkConfProperty, spark_thriftspark_conf_properties, "spark.sql.streaming.streamingQueryListeners", "com.hortonworks.spark.atlas.SparkAtlasStreamingQueryEventTracker", ",")
...
class Spark2Validator(service_advisor.ServiceAdvisor):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.validators = [("spark-defaults", self.validateSpark2DefaultsFromHDP25),
                       ("spark-thrift-sparkconf", self.validateSpark2ThriftSparkConfFromHDP25),
                       ("spark-atlas-application-properties-override", self.validateSpark2AtlasApplicationPropertiesFromHDP30)]
