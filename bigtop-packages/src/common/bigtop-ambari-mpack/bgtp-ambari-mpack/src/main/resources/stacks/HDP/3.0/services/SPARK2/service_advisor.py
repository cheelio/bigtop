  ...
  def recommendSPARK2ConfigurationsFromHDP30(self, configurations, clusterData, services, hosts):
    ...
    if "spark2-atlas-application-properties-override" in services["configurations"]:
      ...
      if spark2_sac_enabled:
        ...
        self.setOrAddValueToProperty(putSpark2DefautlsProperty, spark2_defaults_properties, "spark.driver.extraClassPath", "/usr/lib/hadoop/spark-atlas-connector/*", ":")
        ...
        self.setOrAddValueToProperty(putSpark2ThriftSparkConfProperty, spark2_thriftspark_conf_properties, "spark.driver.extraClassPath", "/usr/lib/hadoop/spark-atlas-connector/*", ":")
        ...
        self.removeValueFromProperty(putSpark2DefautlsProperty, spark2_defaults_properties, "spark.driver.extraClassPath", "/usr/lib/hadoop/spark-atlas-connector/*", ":")
        ...
        self.removeValueFromProperty(putSpark2ThriftSparkConfProperty, spark2_thriftspark_conf_properties, "spark.driver.extraClassPath", "/usr/lib/hadoop/spark-atlas-connector/*", ":")
