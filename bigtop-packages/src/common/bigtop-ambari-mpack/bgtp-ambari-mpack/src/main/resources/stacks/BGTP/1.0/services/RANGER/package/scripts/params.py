...
ranger_conf = format('/usr/lib/ranger-admin/conf')
ranger_admin_services_file = format('/usr/lib/ranger-admin/ews/ranger-admin-services.sh')

usersync_home  = format('/usr/lib/ranger-usersync')
ranger_ugsync_conf = format('/usr/lib/ranger-usersync/conf')
usersync_services_file = format('/usr/lib/ranger-usersync/ranger-usersync-services.sh')

ranger_tagsync_home  = format('/usr/lib/ranger-tagsync')
ranger_tagsync_conf = format('/usr/lib/ranger-tagsync/conf')
tagsync_services_file = format('/usr/lib/ranger-tagsync/ranger-tagsync-services.sh')
